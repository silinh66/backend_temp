...
(async () => {
  const res = await fetch(
    "https://fiin-tools.ssi.com.vn/Screener/GetScreenerItems",
    {
      ...
      body: '{"comGroupCode":"All","icbCode":"All","parameters":[{"name":"Biến động giá 1 ngày","code":"PercentPriceChange1Day","type":"Range","selectedValue":[-0.0996,0.0626],"valueRange":[-0.14847162,0.15],"unit":"Percentage"}],"page":1,"pageSize":30,"OrderBy":"StockScreenerItem.Ticker","Direction":"ASC"}',
      method: "POST",
    }
  );
